...
{
    public class UniversityAuthRepository : IUniversityAuthRepository
    {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly SignInManager<ApplicationUser> _signInManager;
        private readonly ApplicationDbContext _context;

        public UniversityAuthRepository(
        ...
        public async Task<Result<University>> CreateUniversityProfileAsync(University university)
        {
            try
            {
            ...
            {
                return Result.Failure<University>(AuthErrors.CompanyCreationFailed); // ممكن تغير الرسالة لـ UniversityCreationFailed
            }
        }
        ...
        public async Task<ApplicationUser?> GetUserByEmailAsync(string email)
        {
            return await _userManager.Users
                .Include(u => u.UniversityProfile) // افترض إن عندك Navigation property
        ...
        public async Task<University?> GetUniversityProfileByUserIdAsync(string userId)
        {
