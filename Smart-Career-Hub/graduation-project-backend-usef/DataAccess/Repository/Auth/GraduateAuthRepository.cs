...
{
    public class GraduateAuthRepository : IGraduateAuthRepository
    {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly SignInManager<ApplicationUser> _signInManager;
        private readonly ApplicationDbContext _context;

        public GraduateAuthRepository(
        ...
        public async Task<Result<Graduates>> CreateGraduateProfileAsync(Graduates graduate)
        {
            try
            {
                await _context.Graduate.AddAsync(graduate);
                await _context.SaveChangesAsync();
                return Result.Success(graduate);
            }
            catch
            {
                return Result.Failure<Graduates>(AuthErrors.GraduateCreationFailed);
            }
        }
        ...
        public async Task<Graduates?> GetGraduateProfileByUserIdAsync(string userId)
        {
            return await _context.Graduate
