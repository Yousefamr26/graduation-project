...
public static class RoadmapMappingConfig
{
    public static void RegisterMappings()
    {
      ...
      .MapWith(src => new RoadmapResponse(
          ...
          src.CreatedAt,
          src.TotalPoints,
          src.Company != null && src.Company.OrganizationName != null
              ? src.Company.OrganizationName
              : src.TrainingCenter != null && src.TrainingCenter.Name != null
                  ? src.TrainingCenter.Name
                  : string.Empty,
          src.Price,
        ...
        TypeAdapterConfig<LearningMaterialSec34, LearningMaterialResponse>
            ...
            .MapWith(src => new LearningMaterialResponse(
                ...
                src.Points // <-- Added missing Points argument
            ));
        ...
        TypeAdapterConfig<QuizAnswer, QuizAnswerResponse>
            ...
            .MapWith(src => new QuizAnswerResponse(
                src.Id,
                src.Attempt != null ? src.Attempt.UserId.ToString() : string.Empty, // تحويل int لـ string
                src.AnswerText ?? string.Empty,
                src.AnswerFile??string.Empty
            ));
    }
}
