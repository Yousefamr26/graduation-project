...
namespace SmartCareerHub.Controllers.Auth
{
    ...
    public class TrainingCenterAuthController : ControllerBase
    {
        private readonly ITrainingCenterAuthService _authService;

        public TrainingCenterAuthController(ITrainingCenterAuthService authService)
        {
        ...
        // ==============================
        [HttpPost("register")]
        public async Task<IActionResult> RegisterTrainingCenter([FromForm] TrainingCenterRegisterRequest request)
        {
            try
            {
                var result = await _authService.RegisterTrainingCenterAsync(request);
                if (!result.IsSuccess)
        ...
        // ==============================
        // POST /api/trainingcenterauth/verify-email
        // ==============================
        ...
        // ==============================
        // POST /api/trainingcenterauth/resend-otp
        // ==============================
        [HttpPost("resend-otp")]
        ...
        // ==============================
        // POST /api/trainingcenterauth/login
        // ==============================
        [HttpPost("login")]
