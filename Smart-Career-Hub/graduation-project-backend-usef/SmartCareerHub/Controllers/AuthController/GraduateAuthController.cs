...
namespace SmartCareerHub.Controllers.Auth
{
    ...
    public class GraduateAuthController : ControllerBase
    {
        private readonly IGraduateAuthService _authService;

        public GraduateAuthController(IGraduateAuthService authService)
        {
        ...
        // ==============================
        [HttpPost("register")]
        public async Task<IActionResult> RegisterGraduate([FromForm] RegisterGraduateRequest request)
        {
            try
            {
                var result = await _authService.RegisterGraduateAsync(request);
                if (!result.IsSuccess)
        ...
        // ==============================
        // POST /api/graduateauth/verify-email
        // ==============================
        ...
        // ==============================
        // POST /api/graduateauth/resend-otp
        // ==============================
        [HttpPost("resend-otp")]
