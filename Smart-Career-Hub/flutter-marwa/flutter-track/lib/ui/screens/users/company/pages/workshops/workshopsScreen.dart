        ...
        child: FloatingActionButton(
          onPressed: () async {
            final result = await Navigator.push(context,
                MaterialPageRoute(builder: (_) => const CreateEditWorkshopScreen(workshopData: null)));
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ActionButton(icon: Icons.edit, text: "Edit", color: const Color(0xff1676C4),
                  onTap: () async {
                    final result = await Navigator.push(context,
                        MaterialPageRoute(builder: (_) => CreateEditWorkshopScreen(workshopData: w)));
                    if (result == true && mounted) { await _fetchWorkshops();
...
class _WorkshopHistoryScreenState extends State<WorkshopHistoryScreen> {
  final WorkshopRepository workshopRepo = WorkshopRepository();
