...
class CreateEditWorkshopUniScreen extends StatefulWidget {
  final Map<String, dynamic>? workshopData;

  const CreateEditWorkshopUniScreen({super.key, this.workshopData});

  @override
  State<CreateEditWorkshopUniScreen> createState() =>
      _CreateEditWorkshopUniScreenState();
}

class _CreateEditWorkshopUniScreenState extends State<CreateEditWorkshopUniScreen> {
