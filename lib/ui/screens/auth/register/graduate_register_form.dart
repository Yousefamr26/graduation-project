...
// ✅ FIXED: removed unused 'package:intl/intl.dart' import
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (authRepo.isSuccessResponse(response)) {
        ...
        // ✅ FIXED: added mounted check before navigation
        if (mounted) {
          Navigator.push(
            context,
            MaterialPageRoute(
      ...
      // ✅ FIXED: added mounted check before setState in finally
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(
              ...
              validator: (v) =>
              v?.isEmpty ?? true ? 'Experience summary is required' : null,
            ),
            const SizedBox(height: 24),
