...
class _EditCompanyProfileScreenState extends State<EditCompanyProfileScreen> {
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      // اقرأ الـ user_data الموجود وعدّل عليه
      final rawData  = prefs.getString('user_data');
      final existing = rawData != null
          ? json.decode(rawData) as Map<String, dynamic>
          : <String, dynamic>{};

      // استخرج المدينة والدولة من الـ location field
      // الـ format المتوقع: "City, Country"
      ...
      await prefs.setString('user_data', json.encode(updatedData));
      debugPrint('💾 [EDIT PROFILE] Saved: ${updatedData['name']}');

      // ── 2. ارجع بالبيانات المحدّثة للـ profile screen ────────
      if (!mounted) return;
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: _companyLogo == null
                              ...
                              Color(0xff0d5fa3)
                                ...
                                : null,
                            border: Border.all(
                                color: const Color(0xff1676C4), width: 3),
